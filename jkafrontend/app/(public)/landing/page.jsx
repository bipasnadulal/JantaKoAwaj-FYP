      ...
      <section className="flex flex-col md:flex-row min-h-screen items-center justify-center px-6 py-12 bg-gray-50">
        ...
        <div className="md:w-1/2 space-y-6 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="space-x-4">
            <button className='bg-blue-500 text-white px-4 py-2 rounded cursor-pointer' onClick={handleNewComplaint}>Submit Complaint</button>
            <a href="/complaintsPage" className="text-blue-500 px-4 py-2 rounded border-2 text-center hover:bg-blue-500 hover:text-white">View Complaints</a>
          </div>
        </div>
...
<div className="max-w-6xl mx-auto">
          ...
          <div className='grid gird-cols-1 md:grid-cols-2 gap-10 mt-12 ml-0'>
